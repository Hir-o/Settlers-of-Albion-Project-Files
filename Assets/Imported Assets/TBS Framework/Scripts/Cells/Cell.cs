...
namespace TbsFramework.Cells
{
    ...
    public abstract class Cell : MonoBehaviour, IGraphNode, IEquatable<Cell>
    {
        ...
        protected virtual void OnMouseEnter()
        {
            ...
            if (CellHighlighted != null) CellHighlighted.Invoke(this, new EventArgs());

            if (isUnitSpawnable)
            {
                if (ObjectHolder.Instance.purchasedUnitGhost != null)
                {
                    ObjectHolder.Instance.purchasedUnitGhost.SetActive(true);
                    ObjectHolder.Instance.purchasedUnitGhost.transform.position = transform.position;
                }
            }
            else
            {
        ...
        {
            if (CellDehighlighted != null) CellDehighlighted.Invoke(this, new EventArgs());
        }
        ...
        void OnMouseDown()
        {
            ...
            if (CellClicked != null) CellClicked.Invoke(this, new EventArgs());

            if (isUnitSpawnable && ObjectHolder.Instance.purchasedUnit != null)
            {
                UnitSpawner.Instance.SpawnUnit(ObjectHolder.Instance.purchasedUnit, this);
        ...
        public int GetDistance(IGraphNode other) { return GetDistance(other as Cell); }
