...
Shader "Shadero Customs/tent"
{
Properties
{
[PerRendererData] _MainTex("Sprite Texture", 2D) = "white" {}
_ColorFilters_Fade_1("_ColorFilters_Fade_1", Range(0, 1)) = 0.25
...
float4 _ColorFilters_1 = ColorFilters(_MainTex_1,float4(0.6,1.12,0.36,-0.56),float4(0.24,1,0.02,-0.2),float4(0,-0.26,1,0.12),_ColorFilters_Fade_1);
